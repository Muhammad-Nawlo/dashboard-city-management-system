...
import { Button, DatePicker, Form, Input, InputNumber, message, Select, Switch, Tag, Upload } from 'antd';
      ...
      {Object.keys(fields).map((key) => {
        ...
        if ((isUpdateForm && !field.disableForUpdate) || !field.disableForForm) {
          ...
          if (field.hasFeedback)
            ...
            if (feedback == field.feedback) return <FormElement key={key} field={field} isUpdateForm={isUpdateForm} />;
          } else {
...
function FormElement({ field, feedback, setFeedback, isUpdateForm }) {
  ...
  const FilesComponent = () => (
    ...
    >
      <Upload beforeUpload={beforeUpload} multiple={field.multiple}>
