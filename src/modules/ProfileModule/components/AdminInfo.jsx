      ...
      <Row align="middle">
        ...
        <Col xs={{ span: 24 }} sm={{ span: 18 }}>
          <Descriptions column={1} size="middle">
            ...
            <Descriptions.Item label={translate('email')}>{currentAdmin?.user?.email}</Descriptions.Item>
            <Descriptions.Item label={translate('role')}>{currentAdmin?.user?.role?.name}</Descriptions.Item>
          </Descriptions>
        </Col>
      </Row>
      <Divider />
